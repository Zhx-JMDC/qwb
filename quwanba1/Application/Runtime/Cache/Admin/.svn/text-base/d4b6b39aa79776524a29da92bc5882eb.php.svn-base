	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="well">
				...
				<div class="row">
					<div class="col-sm-12">
						<a href="<?php echo U('Shop/goods_add_page');?>"><button class="btn btn-primary pull-right">新增</button></a>
						<button class="btn btn-primary pull-right" style="margin-right: 10px;">导出</button>
...
<script type="text/javascript">
	...
	<script>
		$('#button-filter').on('click', function() {
			debugger
			var url = Think.APP+'/Admin/Shop/index?token=lalala';
		...
		function status_change(id) {
			$.ajax({
				url: "<?php echo U('Shop/status_change');?>",
				type: 'post',
				data: {'id': id},
				success: function (data) {
					window.location.href = "<?php echo U('Shop/index');?>";
