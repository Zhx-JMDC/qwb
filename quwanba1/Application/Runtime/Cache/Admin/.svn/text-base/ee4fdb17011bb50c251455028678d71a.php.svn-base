    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="<?php echo U('AllianceShop/shop_add_page');?>">刷新</a>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo U('ShopClass/add_class');?>" method="post" enctype="multipart/form-data" id="form-product" class="target-form form-horizontal">
                        ...
                        <div class="tab-pane active" id="tab-general">
                            <div class="tab-pane" id="language">
                                <div class="form-group">
                                    ...
                                    <input name="name" placeholder="分类名称"  class="form-control" value="<?php echo ($_class["name"]); ?>" required/>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">图标</label></br>
                                    <?php if(empty($_class["icon"])): else: ?><img src="<?php echo ($_class["icon"]); ?>"><?php endif; ?>
