    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="<?php echo U('Ad/ad_add_page');?>">刷新</a>
    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo U('Ad/ad_add');?>" method="post" enctype="multipart/form-data" id="form-product" class="target-form form-horizontal">
...
<script type="text/javascript">
    ...
    <script>
        $("input[type='radio'][name=conditions][value='<?php echo ($shop["conditions"]); ?>']").attr("checked",true);
        $("input[type='radio'][name=shop_type][value='<?php echo ($shop["shop_type"]); ?>']").attr("checked",true);
