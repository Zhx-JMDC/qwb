...
<div class="body" style="width:100%">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="form-horizontal form-bordered" action="<?php echo U('Public/update');?>" method="post">
                <div class="form-group">
                    <label class="col-sm-3 control-label">管理员用户名</label>
                    <div class="col-sm-6">
                        <input type="text" name="username" placeholder="管理员用户名" class="form-control" value="<?php echo ($_SESSION["username"]); ?>" readonly="true"/>
                    </div>
                </div>
                <div class="form-group">
