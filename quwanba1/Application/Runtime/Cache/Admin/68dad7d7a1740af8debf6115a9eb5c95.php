    ...
    <div class="container-fluid">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo U('ShopClass/edit_shop_class');?>" method="post" enctype="multipart/form-data" id="form-product" class="target-form form-horizontal">
                    <div class="tab-content">
                        <!--常规-->
                        <div class="tab-pane active" id="tab-general">
                            <div class="tab-pane" id="language">
                                <div class="form-group">
                                    <input type="hidden" name="id" value="<?php echo ($_class["id"]); ?>">
