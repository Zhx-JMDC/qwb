	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="well">
				...
				<div class="row">
					<div class="col-sm-12">
						<a><button class="btn btn-primary pull-right" style="margin-right: 10px;" onclick='window.location.href="<?php echo U('Shop/goods_export');?>?type=3"'>导出</button></a>
...
<script type="text/javascript">
	...
	<script>
		$('#button-filter').on('click', function() {
			debugger
			var url = Think.APP+'/Admin/ShopHot/index?token=lalala';
