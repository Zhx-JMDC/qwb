	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="well">
				...
				<div class="row">
					<div class="col-sm-12">
						<a><button class="btn btn-primary pull-right" style="margin-right: 10px;" onclick='window.location.href="<?php echo U('AllianceShop/shop_export');?>?type=0"'>导出</button></a>
			...
			<div class="data-table table-striped">
				<table class="table">
					...
					<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td>
									<a href="<?php echo U('HotShop/hot_shop_detail',array('id'=>$vo['id']));?>">查看</a>
...
<script type="text/javascript">
	...
	<script>
		$('#button-filter').on('click', function() {
			var url = Think.APP+'/Admin/HotShop/index?token=lalala';
		...
		function shopDel(id){
			if (confirm("你确定删除吗？")) {
				$.ajax({
					...
					data: {'id': id},
					success: function (data) {
						window.location.href = "<?php echo U('HotShop/index');?>";
					}
				});
			}
		}
