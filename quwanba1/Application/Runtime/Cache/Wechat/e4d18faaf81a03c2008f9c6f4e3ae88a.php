...
<body style="background-color: #f5f5f5">
	...
	<div id="content">
		<div class="cashgetMain">
			...
			<p class="cashgetMain_p2">成为S级旅行家可提取饭票</p>
			<p class="cashgetMain_p3"><?php if(empty($wait_income)): ?><span>F0.00</span><?php else: ?><span>F<?php echo ($wait_income); ?></span><?php endif; ?></p>
			<div class="representInc_S">
				<p class="representAno_p2">成为S级代言人</p>
				<p><a href="<?php echo U('Spokesman/buy_card');?>"><img src="/quwanba1/Public/Wechat/Images/vip_letter_s_dark.png"></a></p>
			</div>
		</div>
